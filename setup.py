...
setup(
    ...
    url="https://github.com/francisliu2/hawkes-first-passage",
    ...
    entry_points={
        "console_scripts": [
            "hawkes-calibrate=hawkes_first_passage.scripts.calibrate:main",
            "hawkes-simulate=hawkes_first_passage.scripts.simulate:main",
        ],
    },
)