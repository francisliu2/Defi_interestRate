...
Usage:
    python -m jobs.calibrate_eth_btc   # calibrate once
    python -m jobs.legacy_jobs.numerical_comparison
...
from optimal_long_short.utils.helpers import load_calibrated_params, standardised_moments
