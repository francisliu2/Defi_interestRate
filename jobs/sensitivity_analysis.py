...
SWEEPS = [
    (
        ...
        # Benchmark λ = 2.0 placed at index 2 for solid-line treatment
        [(r"$\lambda\!=\!0.5$",          _p(lam1=0.5,  lam2=0.5),  BASE_B, BASE_T),
         (r"$\lambda\!=\!5.0$",          _p(lam1=5.0,  lam2=5.0),  BASE_B, BASE_T),
         (r"$\lambda\!=\!2.0\ \rm(bm)$", _p(lam1=2.0,  lam2=2.0),  BASE_B, BASE_T),
    ...
    (
        ...
        [(r"$\rho\!=\!-0.80$",          _p(rho=-0.80), BASE_B, BASE_T),
         ...
         (r"$\rho\!=\!0.50\ \rm(bm)$",  _p(rho= 0.50), BASE_B, BASE_T),
    ...
    (
        ...
        [(r"$\sigma\!\times\!0.3$",           _p(sigma1=0.09, sigma2=0.075), BASE_B, BASE_T),
         ...
         (r"$\sigma\!\times\!1.0\ \rm(bm)$",  _p(sigma1=0.30, sigma2=0.250), BASE_B, BASE_T),
    ...
    (
        ...
        [(r"$b\!=\!0.30$",          BASE, 0.30, BASE_T),
         ...
         (r"$b\!=\!0.80\ \rm(bm)$", BASE, 0.80, BASE_T),
