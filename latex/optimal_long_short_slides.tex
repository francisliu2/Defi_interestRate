...
\begin{frame}{Constructing the Long--Short Position}
  \begin{center}
    \begin{tabular}{@{}p{0.15\linewidth}p{0.45\linewidth}p{0.30\linewidth}@{}}
      ...
      2 & Borrow \$0.73-worth ETH & Short ETH liability \\
      3 & Sell ETH into \$0.73-worth BTC & Self-financing conversion \\
      4 & Re-supply BTC as collateral & Total BTC collateral: \$1.73 \\
      \midrule
  ...
  \begin{itemize}
    ...
    \item BTC collateral: \$1.73; ETH debt: \$0.73
    \item $(b,\ell_{\max})=(0.78,0.73)$; $H_0=0.78\times1.73/0.73\approx1.85$
...
\begin{frame}{Looping the Position}
  ...
  \]
  Aave illustration $(b,\ell_{\max})=(0.78,0.73)$:
  \[
    V_1^{(\infty)}=3.704,
    \qquad
    V_2^{(\infty)}=2.704,
    \qquad
    H_0^{(\infty)}=\frac{b}{\ell_{\max}}\approx1.068
  \]
...
\begin{frame}{Unwinding and Taking Profit}
  ...
  \begin{center}
    \begin{tabular}{@{}p{0.17\linewidth}r r c r p{0.20\linewidth}@{}}
      ...
      \midrule
      Entry & \$1.73 & \$0.73 & $1.85$ & \$1.00 & Hold \\
      Favorable move & \$1.903 & \$0.608 & $2.44$ & \$1.295 & Voluntary unwind \\
      \bottomrule
    \end{tabular}
  \end{center}
  \vspace{0.5em}
...
\begin{frame}{Aave Liquidation and Immediate Risk}
  ...
  \[
    ...
    =
    \frac{0.78\,V_{1,t}}{V_{2,t}},
    \qquad
    H_t<1
    \Longleftrightarrow
    \frac{V_{2,t}}{V_{1,t}}>0.78
  \]
  \vspace{0.15em}
  \begin{center}
    \begin{tabular}{@{}p{0.17\linewidth}r r c r p{0.20\linewidth}@{}}
      ...
      \midrule
      Entry & \$1.73 & \$0.73 & $1.85$ & \$1.00 & Safe \\
      Adverse move & \$1.298 & \$1.022 & $0.99$ & \$0.276 & Liquidatable \\
      \bottomrule
    \end{tabular}
  \end{center}
  \vspace{0.35em}
...
\begin{frame}{Payoff Function from the Trade}
  ...
  \[
    ...
    \qquad n_1S_{1,0}=1.73,\qquad n_2S_{2,0}=0.73
  \]
  Therefore:
  \[
    \Pi_T=
    \left(
      1.73\,\frac{S_{1,T}}{S_{1,0}}
      -
      0.73\,\frac{S_{2,T}}{S_{2,0}}
    \right)\one_{\{\tau>T\}}
  \]
...
\begin{frame}{Numerical Example}
  ...
  \begin{itemize}
    ...
    \item Host-specific runtime: Laplace $\approx0.10$s vs grid-monitored MC $\approx49$--$50$s
  \end{itemize}
\end{frame}
...
\begin{frame}{Same Engine, Different Selections}
  \scriptsize
  Baseline calibration; 200-point grid on $H_0\in[1.068,2.000]$
  \vspace{0.3em}
  ...
  \begin{center}
    \begin{tabular}{llrrr}
      ...
      \midrule
      Max.\ leverage under cap & $\bar p=0.05$ & $1.331$ & $2.417$ & $0.0478$ \\
      Max.\ leverage under cap & $\bar p=0.10$ & $1.274$ & $2.577$ & $0.0980$ \\
      Max.\ leverage under cap & $\bar p=0.20$ & $1.214$ & $2.799$ & $0.1976$ \\
      Unconditional killed MV & $\alpha=1$ & $2.000^\dagger$ & $1.639$ & $<10^{-4}$ \\
      Conditional MV $+$ penalty & $(\alpha,\delta)=(1,0)$ & $1.068^\dagger$ & $3.704$ & $0.6937$ \\
      Conditional MV $+$ penalty & $(\alpha,\delta)=(1,0.5)$ & $2.000^\dagger$ & $1.639$ & $<10^{-4}$ \\
      \bottomrule
    \end{tabular}
  \end{center}
  \vspace{0.35em}
...
\begin{frame}{Sampling Uncertainty Is Material}
  ...
  \begin{center}
    \begin{tabular}{lrr}
      ...
      \midrule
      $p_{\mathrm{surv}}$ at $H_0=1.274$ & $0.902$ & $[0.483,0.978]$ \\
      Selected $H_0$ & $1.274$ & $[1.175,1.536]$ \\
      Selected $L_0$ & $2.577$ & $[2.032,2.974]$ \\
      \bottomrule
    \end{tabular}
  \end{center}
  \vspace{0.6em}
