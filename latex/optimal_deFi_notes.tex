...
\begin{enumerate}
  ...
  \begin{enumerate}
    ...
    \item There is a practical relevancy to investors. 
    \item Our work is beneficial to the DeFi lending platforms as we detail the scheme to form a portfolio on the lending platform. 
