"""Paired moving-block bootstrap services for calibration uncertainty.
...
from optimal_long_short.model.kou_model import validate_moment_admissibility
...
from optimal_long_short.model.sizing import select_liquidation_constrained
