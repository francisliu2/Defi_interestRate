...
jobs/calibration/calibrate_eth_btc.py) in its data-selected long/short order. Re-running
calibrate_eth_btc.py and then this script fully reproduces all tables.

Usage:
    python jobs/calibration/calibrate_eth_btc.py   # calibrate once
    python jobs/monte_carlo/numerical_comparison.py
