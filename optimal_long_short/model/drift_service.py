"""Drift-convention service for calibrated Kou parameters.
...
def with_muX_drift_view(
    ...
    *,
    ...
    return _copy_with(
        params,
        mu1=next_muX1 + params.log_to_price_correction1,
        mu2=next_muX2 + params.log_to_price_correction2,
    )
...
def expected_log_return_drift(params: KouParams) -> tuple[float, float]:
    ...
    """
    return (
        params.muX1 + params.mean_jump_rate1,
        params.muX2 + params.mean_jump_rate2,
    )
...
def drift_summary(params: KouParams) -> dict[str, dict[str, float] | str]:
    ...
    return {
        ...
        "asset1": {
            ...
            "diffusion_ito_correction": params.diffusion_ito_correction1,
            "jump_price_compensator": params.jump_price_compensator1,
            "log_to_price_correction": params.log_to_price_correction1,
            "muX_log_process": params.muX1,
            "expected_log_return_drift": log1,
        },
        "asset2": {
            "mu_price_growth": params.mu2,
            "diffusion_ito_correction": params.diffusion_ito_correction2,
            "jump_price_compensator": params.jump_price_compensator2,
            "log_to_price_correction": params.log_to_price_correction2,
