...
Usage:  python jobs/frontier_analysis.py
        python jobs/frontier_analysis.py --delta-mu1 0.02 --delta-mu2 -0.01
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--h0-count", type=int, default=70)
...
def main() -> None:
    ...
    print(f"Loaded WBTC/WETH calibrated params  (b={base_b:.2f}, h0_min={h0_min:.4f})")
    ...
    print(
        ...
        "effective_mu is used inside Psi/moments."
    )
    print(
        "Spread drifts: "
        f"mu1-mu2={ds['spread']['mu_price_growth_1_minus_2']:.4f}, "
        f"eff_mu1-eff_mu2={ds['spread']['effective_mu_1_minus_2']:.4f}"
    )
