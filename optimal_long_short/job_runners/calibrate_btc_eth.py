...
Rate adjustment to mu_i (price-growth drift, annualised):
  ...
  mu2 += borrow_apr_WETH / 100     (borrow cost raises the required
...
def save_params(
    ...
    payload = {
        ...
        "first_moment_diagnostics": {
            ...
            "model_raw_ecf": {
                "mu_price_growth": {
                    "WBTC": result.params.mu1,
                    "WETH": result.params.mu2,
                },
                "muX_log_process": {
                    "WBTC": result.params.muX1,
                    "WETH": result.params.muX2,
                },
                "expected_log_return_drift": {
                    "WBTC": raw_log1,
                    "WETH": raw_log2,
